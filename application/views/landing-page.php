...
<html>
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-inverse" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand" href="#page-top">MECO</a>
                    ...
                    <?php
                        if(isset($session)){
                            if($session['userLevel'] == 1){
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="Admins">Dashboard</a>
                                </li>
                                <?php
...
<!--                    </li>-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#team">Creator</a>
                    </li>
                    <li class="nav-item">
...
//                        print_r($arrFiture);
                    ...
                    <div class="col-md-3">
                        ...
                        <h4 class="service-heading"><?php echo $response[$i]['Nama Paket']; ?></h4>
                        <p class="text-muted">IDR <?php echo number_format($response[$i]['Harga'],2,',','.'); ?> /month</p>
                        <p class="text-muted">
                        <ul class="fa-ul">
                            <?php
                                if($arrFiture[0] == 1){
                            ...
                            if($arrFiture[1] == 1){
                                if($response[$i]['Nama Paket'] == 'Silver'){
                                    ?>
                                        <li><i class="fa-li fa fa-check"></i>3-Times Printable Report</li>
                                    <?php
                                }elseif($response[$i]['Nama Paket'] == 'Gold'){
                                    ?>
                                    <li><i class="fa-li fa fa-check"></i>6-Times Printable Report</li>
                                    <?php
                                }elseif($response[$i]['Nama Paket'] == 'Platinum'){
                                    ?>
                                    <li><i class="fa-li fa fa-check"></i>Unlimited Printable Report</li>
                                    <?php
                                }
                            }
                            if($arrFiture[2] == 1){
                                ?>
                                <li><i class="fa-li fa fa-check"></i>Unlimited Upload Data</li>
                                <?php
                            }else{
                                ?>
                                <li><i class="fa-li fa fa-times"></i>Unlimited Upload Data</li>
...
<!--    </section>-->
    ...
    <!-- About -->
    <section id="about" class="bg-faded">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Introducing our amazing team</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
...
<!--                </div>-->
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <p class="large text-muted"><i class="fa fa-quote-left" aria-hidden="true"></i> The strength of the team is each member. The strength of each member is the team. <i class="fa fa-quote-right" aria-hidden="true"></i> </p>
                        <p> - Phil Jackson</p>
                </div>
            </div>
        </div>
...
<!--    </section>-->
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; MECO 2017</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li class="list-inline-item">
